-- Insert realistic mock items
INSERT INTO items (title, description, category, condition, price_per_day, deposit_amount, location, images, owner_id) VALUES
-- Electronics
('MacBook Pro 16" M3 Pro', 'Latest MacBook Pro with M3 Pro chip, 32GB RAM, 1TB SSD. Perfect for video editing, development, and professional work. Comes with original charger and box.', 'electronics', 'excellent', 89.99, 1500.00, 'San Francisco, CA', 
...
('Sony A7R V Camera Kit', 'Professional mirrorless camera with 61MP sensor. Includes 24-70mm f/2.8 lens, 64GB memory card, extra batteries, and camera bag. Perfect for photography projects.', 'electronics', 'excellent', 125.00, 2500.00, 'Los Angeles, CA',
...
('Table Saw - Bosch Professional', 'High-precision table saw with fence system. Ideal for woodworking projects, cabinet making, and precise cuts. Includes blade set and safety equipment.', 'tools', 'excellent', 75.00, 500.00, 'Portland, OR',
...
-- Sports Equipment
('Road Bike - Trek Domane SL6', 'Carbon fiber road bike, size 56cm. Shimano Ultegra groupset, comes with helmet, bike computer, and repair kit. Perfect for long rides and training.', 'sports', 'excellent', 45.00, 800.00, 'Denver, CO',
...
('Standing Desk - Adjustable', 'Electric height-adjustable standing desk, 60"x30". Memory presets, cable management, and anti-collision feature. Great for home office setup.', 'furniture', 'excellent', 40.00, 400.00, 'Boston, MA',
...
-- Gaming
('Gaming PC - RTX 4080 Setup', 'High-end gaming PC with RTX 4080, AMD Ryzen 9, 32GB RAM, 2TB NVMe SSD. Perfect for streaming, gaming, and content creation. Includes RGB peripherals.', 'gaming', 'excellent', 95.00, 2000.00, 'Miami, FL',
...
-- Kitchen
('KitchenAid Stand Mixer Pro', 'Professional 6-quart stand mixer in red. Includes pasta attachment, dough hook, and mixing bowls. Perfect for baking enthusiasts and catering events.', 'kitchen', 'excellent', 30.00, 350.00, 'Nashville, TN',
...
-- Books & Education
('Photography Lighting Kit', 'Complete studio lighting setup with 3 softboxes, stands, continuous LED lights, and backdrop. Perfect for portrait photography and product shoots.', 'other', 'excellent', 60.00, 800.00, 'Atlanta, GA',
 '{"https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=500&h=400&fit=crop", "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=500&h=400&fit=crop"}',
 (SELECT id FROM auth.users LIMIT 1));

-- Update the owner_id to use actual user IDs from profiles table
